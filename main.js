...
function allDraw() {gsap.registerPlugin(ScrollTrigger, SplitText);
...
moTl.to(".endtextMobile", {
  ...
  stagger: {
   ...
   ,
    ...
    moTl.fromTo([pairsMobile[2], pairsMobile[7], pairsMobile[8], pairsMobile[11]], {
  opacity: 0,
  scale: 0.2,
},
           {
  ...
  moTl.to([pairsMobile[2], pairsMobile[7], pairsMobile[8], pairsMobile[11]],
           {
  opacity: 0,
  duration: 0.2,
  stagger: {
